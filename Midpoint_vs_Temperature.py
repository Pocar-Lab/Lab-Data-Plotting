...
date_list = ['20190424', '20190516']    # List the dates for all of the data you wish to include in the plot
bias_voltage = '47V'                    # Enter the bias voltage you want to plot at
...
y_range_data = (0.1, 0.6)               # Set the range for the left y-axis (this sets the scale for the data)
y_range_ratio = (0.1, 0.6)              # Set the range for the right y-axis (this sets the scale for the ratio)
